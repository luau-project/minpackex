...
void minpackex_lmstr1_fcn(void *userdata, int m, int n, const double *x, double *fvec, double *fjrow, int *iflag)
{
    /* function minpackex_lmstr1_fcn for lmstr1 example */
    int i;
...
void tlmstr1_minpackex_write_content(FILE *file)
{
    ...
    minpackex_lmstr1((void *)0, &minpackex_lmstr1_fcn, m, n,
            x, fvec, fjac, ldfjac,
