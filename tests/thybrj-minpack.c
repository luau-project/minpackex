...
void minpack_hybrj_fcn(int *n, double *x, double *fvec, double *fjac, int *ldfjac, int *iflag)
{
    /* function minpack_hybrj_fcn for hybrj example */
...
void thybrj_minpack_write_content(FILE *file)
{
    ...
    hybrj_(&minpack_hybrj_fcn, &n, x, fvec, fjac, &ldfjac, &xtol, &maxfev, diag,
