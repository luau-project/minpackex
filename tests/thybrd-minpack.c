...
void minpack_hybrd_fcn(int *n, double *x, double *fvec, int *iflag)
{
    /* function minpack_hybrd_fcn for hybrd example */
...
void thybrd_minpack_write_content(FILE *file)
{
    ...
    hybrd_(&minpack_hybrd_fcn, &n, x, fvec, &xtol, &maxfev, &ml, &mu, &epsfcn,
