...
void minpackex_chkder_fcn(int m, int n, const double *x, double *fvec, double *fjac, int ldfjac, int *iflag)
{
    /* function minpackex_chkder_fcn for chkder example */
...
void tchkder_minpackex_write_content(FILE *file)
{
    ...
    mode = 1;
    minpackex_chkder(m, n, x, fvec, fjac, ldfjac, xp, fvecp, mode, err);
    mode = 2;
    minpackex_chkder_fcn(m, n, x, fvec, fjac, ldfjac, &one);
    minpackex_chkder_fcn(m, n, x, fvec, fjac, ldfjac, &two);
    minpackex_chkder_fcn(m, n, xp, fvecp, fjac, ldfjac, &one);
    minpackex_chkder(m, n, x, fvec, fjac, ldfjac, xp, fvecp, mode, err);
