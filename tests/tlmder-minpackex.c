...
void minpackex_lmder_fcn(void *userdata, int m, int n, const double *x, double *fvec, double *fjac, int ldfjac, int *iflag)
{
    /* function minpackex_lmder_fcn for lmder example */
...
void tlmder_minpackex_write_content(FILE *file)
{
    ...
    minpackex_lmder((void *)0, &minpackex_lmder_fcn, m, n, x, fvec, fjac, ldfjac, ftol, xtol, gtol,
