...
void minpack_lmstr_fcn(int *m, int *n, double *x, double *fvec, double *fjrow, int *iflag)
{
...
void tlmstr_minpack_write_content(FILE *file)
{
    ...
    lmstr_(&minpack_lmstr_fcn, &m, &n, x, fvec, fjac, &ldfjac, &ftol, &xtol, &gtol,
