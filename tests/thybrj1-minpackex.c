...
void minpackex_hybrj1_fcn(void *userdata, int n, const double *x, double *fvec, double *fjac, int ldfjac, int *iflag)
{
    /* function minpackex_hybrj1_fcn for hybrj1 example */
...
void thybrj1_minpackex_write_content(FILE *file)
{
    ...
    minpackex_hybrj1((void *)0, &minpackex_hybrj1_fcn, n, x, fvec, fjac, ldfjac, tol, &info, wa, lwa);
