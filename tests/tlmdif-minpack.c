...
void minpack_lmdif_fcn(int *m, int *n, double *x, double *fvec, int *iflag)
{
    /* function minpack_lmdif_fcn for lmdif example */
...
void tlmdif_minpack_write_content(FILE *file)
{
    ...
    lmdif_(&minpack_lmdif_fcn, &m, &n, x, fvec, &ftol, &xtol, &gtol, &maxfev, &epsfcn,
