...
** https://salsa.debian.org/science-team/minpack/-/blob/354dafc0ac489dc89f3347fe5b4b6fc0a71837db/debian/tlmstr.c
*/
...
void minpackex_lmstr_fcn(void *userdata, int m, int n, const double *x, double *fvec, double *fjrow, int *iflag)
{
    /* function minpackex_lmstr_fcn for lmstr example */
...
void tlmstr_minpackex_write_content(FILE *file)
{
    ...
    minpackex_lmstr((void *)0, &minpackex_lmstr_fcn, m, n, x, fvec, fjac, ldfjac, ftol, xtol, gtol,
